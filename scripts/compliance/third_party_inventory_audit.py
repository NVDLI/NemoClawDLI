...
def self_test() -> list[str]:
    ...
    mutations = (
        ...
        ("argparse explanation", {INVENTORY: document.replace("`argparse@2.0.1` is a JavaScript npm package used transitively by `js-yaml@5.4.1`.", "argparse is unexplained.", 1)}, "missing license-scope explanation"),
