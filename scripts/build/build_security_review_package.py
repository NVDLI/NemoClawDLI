...
def render() -> str:
    ...
    parts = [
        ...
        *bullets(target["explicit_facts"]),
        ...
        "",
        "- Public path: a protected workflow builds one static artifact for static hosting. The browser calls model, Activity and NemoClaw services directly or through a reviewed relay.",
        ...
        *[
        ...
        "Apply these status rules to each theme. Keep private assessment rows outside the repository.",
        "",
