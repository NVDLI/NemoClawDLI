...
CHECKS = [
    ...
    (
        "OpenShell keeps Pomerium direct and Cloudflare relay opt-in",
...
def self_test() -> list[str]:
    ...
    cases = (
        ...
        ("OpenClaw sender-bound Pomerium", "web/nemoclaw/scripts/_connection.js", 'accessProviderForOpenClawUrl(clean) === "pomerium") return false;', 'accessProviderForOpenClawUrl(clean) === "pomerium") return Boolean(accessSession);'),
        ...
        ("OpenShell lets Pomerium select the relay", "web/nemoclaw/scripts/_openshell.js", 'const relayEnabled = resolvedProvider === "cloudflare" &&', 'const relayEnabled = resolvedProvider === "pomerium" &&'),
