...
BOUNDARIES: tuple[tuple[str, str, str], ...] = (
    ...
    ("web/nemoclaw/scripts/_course_assistant.js", '["base", "iframe", "object", "embed"].includes(tag.name)',
    ...
    ("web/nemoclaw/scripts/_course_assistant.js", "export function inspectArtifactHtmlSource",
     "Course Assistant static inspection must not render untrusted artifact HTML"),
    ("scripts/validation/learner_flow_runtime_audit.py", "hostileHtmlScanner",
     "Course Assistant HTML inspection must exercise malformed and active-content mutations"),
    ...
    ("web/nemoclaw/scripts/studio_main.js", 'typeof Document.parseHTML !== "function"',
     "Studio preview must fail closed when the browser lacks a safe HTML parser"),
    ("web/nemoclaw/scripts/studio_main.js", 'Document.parseHTML(String(source))',
     "Studio preview must use the browser's XSS-safe HTML parser"),
...
def self_test(root: Path = ROOT) -> list[str]:
    ...
    cases = (
        ...
        ("child source binding", "web/nemoclaw/scripts/_course_assistant.js",
         ...
         "child bridge"),
        ("artifact inert inspection", "web/nemoclaw/scripts/_course_assistant.js",
         "export function inspectArtifactHtmlSource", "function removedInspectArtifactHtmlSource",
         "must not render untrusted"),
