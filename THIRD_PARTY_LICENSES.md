...
| browser-runtime | js-yaml | 5.4.1 | MIT | [`licenses/js-yaml--5.4.1.txt`](web/nemoclaw/vendor/licenses/js-yaml--5.4.1.txt) |
...
`argparse@2.0.1` is a JavaScript npm package used transitively by `js-yaml@5.4.1`.
...
| security-tooling | cyclonedx-bom | 7.4.0 | Apache-2.0 | [PyPI](https://pypi.org/pypi/cyclonedx-bom/7.4.0/json); [`scripts/security/requirements-sca.lock`](scripts/security/requirements-sca.lock) |
...
| material-tooling | lxml | 6.1.3 | BSD-3-Clause | [PyPI](https://pypi.org/pypi/lxml/6.1.3/json); [`scripts/materials/requirements.lock`](scripts/materials/requirements.lock) |
...
| host-bootstrap, security-tooling | pip | 26.2.1 | MIT | [PyPI](https://pypi.org/pypi/pip/26.2.1/json); [`scripts/security/requirements-sca.lock`](scripts/security/requirements-sca.lock); [`docs/lab_runtime_testing.md`](docs/lab_runtime_testing.md) |
...
| security-tooling | setuptools | 84.0.0 | MIT | [PyPI](https://pypi.org/pypi/setuptools/84.0.0/json); [`scripts/security/requirements-sca.lock`](scripts/security/requirements-sca.lock) |
...
| material-tooling | soupsieve | 2.9.2 | MIT | [PyPI](https://pypi.org/pypi/soupsieve/2.9.2/json); [`scripts/materials/requirements.lock`](scripts/materials/requirements.lock) |
...
| browser-validation | playwright-core | 1.63.0 | Apache-2.0 | [npm](https://www.npmjs.com/package/playwright-core/v/1.63.0); [`scripts/runtime/pnpm-lock.yaml`](scripts/runtime/pnpm-lock.yaml) |
...
| [arXiv:2311.09476](https://arxiv.org/abs/2311.09476) | ARES: An Automated Evaluation Framework for Retrieval-Augmented Generation Systems<br>Authors: Saad-Falcon, Jon, Khattab, Omar, Potts, Christopher, Zaharia, Matei | [CC-BY-4.0](https://creativecommons.org/licenses/by/4.0/) | Reuse and adaptation are allowed, including commercially, with attribution. | 2026-09-12 | `web/nemoclaw/04c-going-further.html` |
...
| [NemoClaw for OpenClaw workflow](https://assets.ngc.nvidia.com/products/api-catalog/nemoclaw/nemoclaw-for-openclaw/workflow.png) | No author listed on the official source page | (c) NVIDIA; no reuse license stated on source asset | recreation | `web/nemoclaw/assets/figures/03a-nemoclaw-workflow.svg` | 2026-08-13 |
...
| web/nemoclaw/assets/figures/03a-nemoclaw-workflow.svg | recreation | NVIDIA NemoClaw for OpenClaw workflow | (c) NVIDIA; no reuse license stated on source asset | [source](https://assets.ngc.nvidia.com/products/api-catalog/nemoclaw/nemoclaw-for-openclaw/workflow.png) |
