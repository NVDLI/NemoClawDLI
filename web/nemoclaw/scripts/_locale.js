...
const PT_TEXT = new Map(Object.entries({
  ...
  "Remote progress is connected. Local verified progress:": "O envio de progresso está conectado. Progresso verificado localmente:",
...
const ES_TEXT = new Map(Object.entries({
  ...
  "Remote progress is connected. Local verified progress:": "El envío del progreso está conectado. Progreso verificado localmente:",
...
const ZH_TEXT = new Map(Object.entries({
  ...
  "Remote progress is connected. Local verified progress:": "远程进度同步已连接。本地验证进度：",
...
const TW_TEXT = new Map(Object.entries({
  ...
  "Remote progress is connected. Local verified progress:": "遠端進度同步已連線。本機驗證進度：",
