...
const PT_TEXT = new Map(Object.entries({
  ...
  "Retry WebSockets through the hosted relay": "Tentar novamente os WebSockets pelo relay hospedado",
  "Use only when a direct gateway or terminal socket fails.": "Use somente quando um socket direto do gateway ou do terminal falhar.",
...
const ES_TEXT = new Map(Object.entries({
  ...
  "Retry WebSockets through the hosted relay": "Reintentar los WebSockets mediante el relay alojado",
  "Use only when a direct gateway or terminal socket fails.": "Úsalo solo cuando falle un socket directo del gateway o del terminal.",
