...
const PT_TEXT = new Map(Object.entries({
  ...
  "Remote progress is off. Nothing is sent until you enable it.": "O envio de progresso está desativado. Nada será enviado até que você o ative.",
  "Enable remote progress": "Ativar envio de progresso",
  "Disconnect this tab": "Desconectar esta guia",
  "Record selections of approved NVIDIA resources": "Registrar seleções de recursos aprovados da NVIDIA",
  "Data, purpose, and retention": "Dados, finalidade e retenção",
  "Sent to NVIDIA DLI Activity API": "Enviado à API de Atividades do NVIDIA DLI",
  "Purpose": "Finalidade",
  "Service status": "Status do serviço",
  "NVIDIA Privacy Policy": "Política de Privacidade da NVIDIA",
  "Privacy choices and requests": "Opções e solicitações de privacidade",
  "Global Privacy Control is enabled. Referral tracking remains off.": "O Global Privacy Control está ativo. O registro de referências permanece desativado.",
  "Connecting to the Activity API.": "Conectando à API de Atividades.",
  "Saved progress:": "Progresso salvo:",
  "Last confirmed progress:": "Último progresso confirmado:",
  "Refresh saved progress": "Atualizar progresso salvo",
  "Waiting for API confirmation.": "Aguardando confirmação da API.",
  "Confirmed by the Activity API.": "Confirmado pela API de Atividades.",
  "Progress records successful course activity checkpoints.": "O progresso registra os pontos de controle das atividades do curso concluídos com sucesso.",
  "The Activity API is unavailable. Local course work is unchanged.": "A API de Atividades está indisponível. O trabalho local do curso não foi alterado.",
  "Remote progress is available only from a validated course build.": "O envio de progresso está disponível somente em uma versão validada do curso.",
  "Open this course over HTTPS to enable remote progress.": "Abra este curso por HTTPS para ativar o envio de progresso.",
  "Remote progress is enabled.": "O envio de progresso está ativado.",
  "Remote progress is unavailable until its data policy is approved.": "O envio de progresso ficará indisponível até a aprovação da política de dados.",
  "Local verified progress:": "Progresso verificado localmente:",
  "Last connection:": "Última conexão:",
  "Remote collection is disabled while privacy, legal, and service-owner review is incomplete.": "A coleta remota permanece desativada enquanto as análises de privacidade, jurídica e do responsável pelo serviço estiverem pendentes.",
  "Service retention:": "Retenção no serviço:",
  "Service-specific retention is not yet confirmed. Remote collection remains disabled.": "O período de retenção do serviço ainda não foi confirmado. A coleta remota permanece desativada.",
  "Service controller:": "Controlador do serviço:",
  "The service controller is not yet confirmed. Remote collection remains disabled.": "O controlador responsável pelo serviço ainda não foi confirmado. A coleta remota permanece desativada.",
  "Service legal basis:": "Base legal do serviço:",
  "The service legal basis is not yet confirmed. Remote collection remains disabled.": "A base legal do serviço ainda não foi confirmada. A coleta remota permanece desativada.",
  "Service sale or sharing disposition:": "Declaração do serviço sobre venda ou compartilhamento:",
  "The service sale or sharing disposition is not yet confirmed. Remote collection remains disabled.": "A declaração do serviço sobre venda ou compartilhamento ainda não foi confirmada. A coleta remota permanece desativada.",
  "Published service target:": "Meta de serviço publicada:",
  "No course-level availability or response-time target is published. Live status is an observation, not an SLA.": "Não há meta publicada de disponibilidade ou tempo de resposta para o curso. O status atual é uma observação, não um SLA.",
  "No connection has been measured in this tab.": "Nenhuma conexão foi medida nesta guia.",
  "The course does not send API keys, prompts, model responses, terminal output, or workspace files to the Activity API.": "O curso não envia chaves de API, prompts, respostas de modelos, saídas do terminal nem arquivos do espaço de trabalho à API de Atividades.",
  "course artifact identifier, version, and digest": "identificador, versão e resumo criptográfico do artefato do curso",
  "opaque activity session identifier and token": "identificador e token opacos da sessão de atividade",
  "verified course progress and completion time": "progresso verificado no curso e horário de conclusão",
  "approved NVIDIA resource identifier and destination when referral tracking is enabled": "identificador e destino do recurso aprovado da NVIDIA quando o registro de referências está ativo",
  "ordinary HTTPS request metadata available to the service operator": "metadados comuns da requisição HTTPS disponíveis ao operador do serviço",
  "save verified course progress and completion": "salvar o progresso verificado e a conclusão do curso",
  "measure selections of approved NVIDIA resources when referral tracking is enabled": "medir seleções de recursos aprovados da NVIDIA quando o registro de referências está ativo",
  "The session identifier and token remain in sessionStorage until the tab closes or the learner disconnects remote progress.": "O identificador e o token da sessão permanecem em sessionStorage até que a guia seja fechada ou o participante desconecte o envio de progresso.",
  "Remote progress is off. Open Activity in the toolbar to enable it.": "O envio de progresso está desativado. Abra Atividade na barra superior para ativá-lo.",
  "Course completed": "Curso concluído",
  "Course completed. You can return to the course home or continue exploring the resources above.": "Curso concluído. Você pode voltar à página inicial ou continuar explorando os recursos acima.",
  "All verified checkpoints are complete. Finish the course when you are ready.": "Todos os pontos de verificação foram concluídos. Finalize o curso quando estiver pronto.",
  "Verified progress:": "Progresso verificado:",
  "Complete the remaining hands-on checkpoints before finishing.": "Conclua os pontos de verificação práticos restantes antes de finalizar.",
  "Course progress is temporarily unavailable. Reload this page to try again.": "O progresso do curso está temporariamente indisponível. Recarregue a página para tentar novamente.",
  "Recording course completion.": "Registrando a conclusão do curso.",
  "Completion was not recorded. Check your connection and try again.": "A conclusão não foi registrada. Verifique a conexão e tente novamente.",
  "Not available in this language; opens in English.": "Ainda não disponível em português; abre em inglês.",
  "course home": "página inicial",
...
const ES_TEXT = new Map(Object.entries({
  ...
  "Remote progress is off. Nothing is sent until you enable it.": "El envío del progreso está desactivado. No se envía nada hasta que lo actives.",
  "Enable remote progress": "Activar el envío del progreso",
  "Disconnect this tab": "Desconectar esta pestaña",
  "Record selections of approved NVIDIA resources": "Registrar selecciones de recursos aprobados de NVIDIA",
  "Data, purpose, and retention": "Datos, finalidad y conservación",
  "Sent to NVIDIA DLI Activity API": "Se envía a la API de actividades de NVIDIA DLI",
  "Purpose": "Finalidad",
  "Service status": "Estado del servicio",
  "NVIDIA Privacy Policy": "Política de privacidad de NVIDIA",
  "Privacy choices and requests": "Opciones y solicitudes de privacidad",
  "Global Privacy Control is enabled. Referral tracking remains off.": "Global Privacy Control está activado. El seguimiento de referencias permanece desactivado.",
  "Connecting to the Activity API.": "Conectando con la API de actividades.",
  "Saved progress:": "Progreso guardado:",
  "Last confirmed progress:": "Último progreso confirmado:",
  "Refresh saved progress": "Actualizar progreso guardado",
  "Waiting for API confirmation.": "Esperando la confirmación de la API.",
  "Confirmed by the Activity API.": "Confirmado por la API de actividades.",
  "Progress records successful course activity checkpoints.": "El progreso registra los puntos de control de las actividades del curso completados correctamente.",
  "The Activity API is unavailable. Local course work is unchanged.": "La API de actividades no está disponible. El trabajo local del curso no cambia.",
  "Remote progress is available only from a validated course build.": "El envío del progreso solo está disponible desde una versión validada del curso.",
  "Open this course over HTTPS to enable remote progress.": "Abre este curso mediante HTTPS para activar el envío del progreso.",
  "Remote progress is enabled.": "El envío del progreso está activado.",
  "Remote progress is unavailable until its data policy is approved.": "El envío del progreso no estará disponible hasta que se apruebe su política de datos.",
  "Local verified progress:": "Progreso verificado localmente:",
  "Last connection:": "Última conexión:",
  "Remote collection is disabled while privacy, legal, and service-owner review is incomplete.": "La recopilación remota permanece desactivada mientras estén pendientes las revisiones de privacidad, legal y del responsable del servicio.",
  "Service retention:": "Conservación en el servicio:",
  "Service-specific retention is not yet confirmed. Remote collection remains disabled.": "El periodo de conservación del servicio aún no está confirmado. La recopilación remota permanece desactivada.",
  "Service controller:": "Responsable del tratamiento:",
  "The service controller is not yet confirmed. Remote collection remains disabled.": "Aún no se ha confirmado el responsable del tratamiento. La recopilación remota permanece desactivada.",
  "Service legal basis:": "Base jurídica del servicio:",
  "The service legal basis is not yet confirmed. Remote collection remains disabled.": "Aún no se ha confirmado la base jurídica del servicio. La recopilación remota permanece desactivada.",
  "Service sale or sharing disposition:": "Declaración del servicio sobre venta o comunicación de datos:",
  "The service sale or sharing disposition is not yet confirmed. Remote collection remains disabled.": "Aún no se ha confirmado la declaración del servicio sobre venta o comunicación de datos. La recopilación remota permanece desactivada.",
  "Published service target:": "Objetivo de servicio publicado:",
  "No course-level availability or response-time target is published. Live status is an observation, not an SLA.": "No hay un objetivo publicado de disponibilidad ni de tiempo de respuesta para el curso. El estado actual es una observación, no un SLA.",
  "No connection has been measured in this tab.": "No se ha medido ninguna conexión en esta pestaña.",
  "The course does not send API keys, prompts, model responses, terminal output, or workspace files to the Activity API.": "El curso no envía claves de API, prompts, respuestas de modelos, salida del terminal ni archivos del espacio de trabajo a la API de actividades.",
  "course artifact identifier, version, and digest": "identificador, versión y resumen criptográfico del artefacto del curso",
  "opaque activity session identifier and token": "identificador y token opacos de la sesión de actividad",
  "verified course progress and completion time": "progreso verificado del curso y hora de finalización",
  "approved NVIDIA resource identifier and destination when referral tracking is enabled": "identificador y destino del recurso aprobado de NVIDIA cuando está activado el seguimiento de referencias",
  "ordinary HTTPS request metadata available to the service operator": "metadatos habituales de la solicitud HTTPS disponibles para el operador del servicio",
  "save verified course progress and completion": "guardar el progreso verificado y la finalización del curso",
  "measure selections of approved NVIDIA resources when referral tracking is enabled": "medir las selecciones de recursos aprobados de NVIDIA cuando está activado el seguimiento de referencias",
  "The session identifier and token remain in sessionStorage until the tab closes or the learner disconnects remote progress.": "El identificador y el token de la sesión permanecen en sessionStorage hasta que se cierre la pestaña o el participante desconecte el envío del progreso.",
  "Remote progress is off. Open Activity in the toolbar to enable it.": "El envío del progreso está desactivado. Abre Actividad en la barra superior para activarlo.",
  "Course completed": "Curso finalizado",
  "Course completed. You can return to the course home or continue exploring the resources above.": "Curso finalizado. Puedes volver a la página de inicio o seguir explorando los recursos anteriores.",
  "All verified checkpoints are complete. Finish the course when you are ready.": "Todos los puntos de control están completos. Finaliza el curso cuando estés listo.",
  "Verified progress:": "Progreso verificado:",
  "Complete the remaining hands-on checkpoints before finishing.": "Completa los puntos de control prácticos restantes antes de finalizar.",
  "Course progress is temporarily unavailable. Reload this page to try again.": "El progreso del curso no está disponible temporalmente. Vuelve a cargar la página para intentarlo otra vez.",
  "Recording course completion.": "Registrando la finalización del curso.",
  "Completion was not recorded. Check your connection and try again.": "No se registró la finalización. Comprueba la conexión e inténtalo de nuevo.",
  "Not available in this language; opens in English.": "Aún no está disponible en español; se abre en inglés.", "course home": "página de inicio",
...
const ZH_TEXT = new Map(Object.entries({
  ...
  "Remote progress is off. Nothing is sent until you enable it.": "远程进度同步已关闭。启用前不会发送任何数据。",
  "Enable remote progress": "启用远程进度同步",
  "Disconnect this tab": "断开此标签页的连接",
  "Record selections of approved NVIDIA resources": "记录对已批准 NVIDIA 资源的选择",
  "Data, purpose, and retention": "数据、用途与保留期限",
  "Sent to NVIDIA DLI Activity API": "发送至 NVIDIA DLI Activity API",
  "Purpose": "用途",
  "Service status": "服务状态",
  "NVIDIA Privacy Policy": "NVIDIA 隐私政策",
  "Privacy choices and requests": "隐私选择与请求",
  "Global Privacy Control is enabled. Referral tracking remains off.": "已启用全球隐私控制。资源选择记录将保持关闭。",
  "Connecting to the Activity API.": "正在连接 Activity API。",
  "Saved progress:": "已保存的进度：",
  "Last confirmed progress:": "上次确认的进度：",
  "Refresh saved progress": "刷新已保存的进度",
  "Waiting for API confirmation.": "正在等待 API 确认。",
  "Confirmed by the Activity API.": "已由 Activity API 确认。",
  "Progress records successful course activity checkpoints.": "进度记录课程活动中已成功完成的检查点。",
  "The Activity API is unavailable. Local course work is unchanged.": "Activity API 当前不可用。本地课程进度不受影响。",
  "Remote progress is available only from a validated course build.": "远程进度同步仅适用于经过验证的课程构建。",
  "Open this course over HTTPS to enable remote progress.": "请通过 HTTPS 打开本课程，以启用远程进度同步。",
  "Remote progress is enabled.": "已启用远程进度同步。",
  "Remote progress is unavailable until its data policy is approved.": "数据政策获批前，远程进度同步不可用。",
  "Local verified progress:": "本地验证进度：",
  "Last connection:": "最近一次连接：",
  "Remote collection is disabled while privacy, legal, and service-owner review is incomplete.": "隐私、法律和服务负责人审核完成前，远程数据收集将保持关闭。",
  "Service retention:": "服务端保留期限：",
  "Service-specific retention is not yet confirmed. Remote collection remains disabled.": "服务端保留期限尚未确认。远程数据收集将保持关闭。",
  "Service controller:": "服务数据控制方：",
  "The service controller is not yet confirmed. Remote collection remains disabled.": "服务数据控制方尚未确认。远程数据收集将保持关闭。",
  "Service legal basis:": "服务处理数据的法律依据：",
  "The service legal basis is not yet confirmed. Remote collection remains disabled.": "服务处理数据的法律依据尚未确认。远程数据收集将保持关闭。",
  "Service sale or sharing disposition:": "服务关于出售或共享数据的说明：",
  "The service sale or sharing disposition is not yet confirmed. Remote collection remains disabled.": "服务关于出售或共享数据的说明尚未确认。远程数据收集将保持关闭。",
  "Published service target:": "已发布的服务目标：",
  "No course-level availability or response-time target is published. Live status is an observation, not an SLA.": "课程尚未发布可用性或响应时间目标。当前状态只是观测结果，不构成 SLA。",
  "No connection has been measured in this tab.": "此标签页尚未测量任何连接。",
  "The course does not send API keys, prompts, model responses, terminal output, or workspace files to the Activity API.": "本课程不会向 Activity API 发送 API 密钥、提示词、模型回复、终端输出或工作区文件。",
  "course artifact identifier, version, and digest": "课程构建的标识符、版本和摘要",
  "opaque activity session identifier and token": "不透明的活动会话标识符和令牌",
  "verified course progress and completion time": "经验证的课程进度和完成时间",
  "approved NVIDIA resource identifier and destination when referral tracking is enabled": "启用资源选择记录时，已批准 NVIDIA 资源的标识符和目标地址",
  "ordinary HTTPS request metadata available to the service operator": "服务运营方可见的常规 HTTPS 请求元数据",
  "save verified course progress and completion": "保存经验证的课程进度和完成状态",
  "measure selections of approved NVIDIA resources when referral tracking is enabled": "启用资源选择记录时，统计对已批准 NVIDIA 资源的选择",
  "The session identifier and token remain in sessionStorage until the tab closes or the learner disconnects remote progress.": "会话标识符和令牌会保留在 sessionStorage 中，直到标签页关闭或学习者断开远程进度同步。",
  "Remote progress is off. Open Activity in the toolbar to enable it.": "远程进度同步已关闭。请在顶部工具栏中打开“学习记录”以启用同步。",
  "Course completed": "课程已完成",
  "Course completed. You can return to the course home or continue exploring the resources above.": "课程已完成。您可以返回课程首页，或继续浏览上方资源。",
  "All verified checkpoints are complete. Finish the course when you are ready.": "所有验证检查点均已完成。准备好后即可完成课程。",
  "Verified progress:": "验证进度：",
  "Complete the remaining hands-on checkpoints before finishing.": "完成其余实践检查点后再结束课程。",
  "Course progress is temporarily unavailable. Reload this page to try again.": "课程进度暂时不可用。请重新加载此页面后重试。",
  "Recording course completion.": "正在记录课程完成状态。",
  "Completion was not recorded. Check your connection and try again.": "未能记录课程完成状态。请检查连接后重试。",
  "Not available in this language; opens in English.": "此语言版本尚未提供；将打开英文页面。",
  "course home": "课程首页",
...
const TW_TEXT = new Map(Object.entries({
  ...
  "results": "結果", "stream · log · return value": "流式輸出 · 日誌 · 傳回值", "request": "請求", "tool": "工具",
  "console input": "控制檯輸入", "course-authored (no public repo)": "課程編寫（無公開儲存庫）",
  "Show token": "顯示 token", "Hide token": "隱藏 token", "Show or hide token": "顯示或隱藏 token", "helpers": "輔助函式", "click to enlarge": "點選放大",
  "*NVIDIA is waiving the fee for the Brev launchable for a limited time to the first 25K users (limited to one redemption per user). Once launched, the user will see a $1.00 credit added to their account, enabling them to complete all 4 modules (~4 hours).": "*NVIDIA 將在限定時間內為前 25,000 名使用者免除 Brev launchable 費用（每位使用者限兌換一次）。啟動後，使用者的帳戶將獲得 1.00 美元額度，可用於完成全部 4 個模組（約 4 小時）。",
  "Live artifacts": "互動頁面",
  "Shared state": "共享狀態",
  "Model calls": "模型呼叫",
  "Model configuration": "模型設定",
  "Web search": "Web 搜尋",
  "Embeddings & similarity": "嵌入與相似度",
  "Tokens & context": "token 與上下文",
  "Raw HTTP": "原始 HTTP",
  "Launchable terminal": "可啟動執行個體終端機",
  "OpenShell policy": "OpenShell 策略",
  "Course content": "課程內容",
  "Diagram strings": "圖表字串",
  "OpenClaw gateway": "OpenClaw 閘道器",
  "Run control": "執行控制",
  "Instrumentation": "追蹤與日誌",
  "Visualization": "視覺化",
  "Other": "其他",
  "Automatic retries for network, HTTP 429, or transient 5xx failures": "針對網路、HTTP 429 或暫時性 5xx 故障自動重試",
  "Failures remain visible. Retries are off by default and apply only before a stream starts.": "故障始終可見。預設關閉重試，且只在流式傳輸開始前重試。",
  "Wait for response headers or the next stream chunk (seconds)": "等待回應標頭或下一個流式資料塊（秒）",
  "Need a value? Select the ? beside that field for its source and fallback.": "需要某個值？請選擇該欄位旁的 ?，檢視其來源和回退值。",
  "I'm a deep research agent. Ask me something and I'll plan a few parallel sub-investigations across curated NVIDIA materials and this course's own sections, then synthesize a grounded answer.": "我是一個深度研究代理程式。請向我提問；我會針對精選的 NVIDIA 資料和本課程內容規劃若干並行子調查，再綜合形成有依據的回答。",
  "How does this course's OpenShell sandbox relate to agent safety in general?": "本課程的 OpenShell 沙箱與一般的代理程式安全有何關係？",
  "What is RAG, and how does this course build it?": "什麼是 RAG？本課程如何建置 RAG？",
  "Compare the ReAct loop with the deep-agent pattern": "比較 ReAct 迴圈和深度代理程式模式",
  "What are the main failure modes of autonomous agents?": "自主代理程式有哪些主要故障模式？",
  "How do production CLI agents sandbox themselves?": "生產環境中的 CLI 代理程式如何進行沙箱隔離？",
  "Trace this course from a single LLM call to an always-on agent": "梳理本課程從單次 LLM 呼叫到持續執行代理程式的演進路徑",
  "✗ Error: Embedding key missing. Open the course setup and configure the persistent embedding route.": "✗ 錯誤：缺少嵌入金鑰。請開啟課程設定並設定持久化嵌入路由。",
  "Error: Embedding key missing. Open the course setup and configure the persistent embedding route.": "錯誤：缺少嵌入金鑰。請開啟課程設定並設定持久化嵌入路由。",
  "Checks env status, toolSearch, stuck approvals, and one trivial command. HEALTHY needs no repair; DEGRADED shows what to inspect next.": "檢查環境狀態、toolSearch、卡住的審批以及一條簡單命令。HEALTHY 表示無需修復；DEGRADED 會指出接下來要檢查的內容。",
  "Disables tools.toolSearch only when the live config has it enabled. Session clearing and restart default off, so running this cell against a healthy launchable is non-destructive.": "僅當即時設定已啟用 tools.toolSearch 時才將其禁用。預設不清除會話、不重啟，因此對健康的可啟動執行個體執行此單元格不會造成破壞性更改。",
  "Tails the gateway/agent log (logs.tail): model calls, tool dispatches, errors, hangs. The deepest view when a run stalls and Health check is green; reasoning itself is not exposed over the gateway.": "持續讀取閘道器/代理程式日誌（logs.tail），包括模型呼叫、工具分派、錯誤和卡頓。當執行停滯但健康檢查為綠色時，這是最深入的診斷檢視；閘道器本身不會公開推理過程。",
  "Detect & recover · health check, then escalating reset": "檢測並恢復 · 先做健康檢查，再逐級重置",
  "Health check": "健康檢查",
  "Runtime logs": "執行階段日誌",
  "Clean up": "清理",
  "Clear": "清除",
  ...
  "revert": "還原",
  "source": "原始碼",
  "Compile your edits and override the helper for this canvas": "編譯修改並在此畫布中替換輔助函式",
  "Restore the original source": "還原原始原始碼",
  "Health check, conditional repair, and logs for the shared OpenClaw harness. Health check runs a command and reads toolSearch. Recover changes toolSearch only when it is enabled; session clearing and restart are separate opt-ins. Runtime logs tails the log when a run stalls.": "共享 OpenClaw 執行框架的健康檢查、條件修復和日誌。健康檢查會執行命令並讀取 toolSearch。僅當 toolSearch 已啟用時，恢復操作才會更改它；清除會話和重啟是獨立的可選操作。執行階段日誌會在執行停滯時持續讀取日誌。",
  "Reconnect": "重新連線", "Saved. Rerun the cell.": "已儲存。請重新執行該單元格。",
  "Figure path is invalid.": "圖路徑無效。", "Figure could not be loaded.": "無法載入圖。",
  "lab only": "僅實驗環境", "streaming…": "正在流式傳輸…", "stopped": "已停止", "error": "錯誤", "reset": "已重置",
  "select": "選擇", "copied ✓": "已複製 ✓", "⎘ copy": "⎘ 複製", "⏹ stopping…": "⏹ 正在停止…", "✓ override active": "✓ 修改已生效",
  "view policy source": "檢視策略原始碼", "hide policy source": "隱藏策略原始碼", "failed step": "失敗步驟",
  "Lessons": "課程", "Review before deployment": "部署前檢查",
  "not yet run": "尚未執行",
  "returned value": "傳回值",
  "raw response": "原始回應",
  "live artifacts": "互動頁面",
  "No OpenClaw": "未檢測到 OpenClaw",
  "The agent doing its job": "代理程式正常執行任務",
  "The agent off the rails": "代理程式行為失控",
  "the agent tries to ": "代理程式嘗試 ",
  "   ·   run Confirm next, then Compare": "   ·   接下來執行“確認”，然後執行“比較”",
  "list available models": "列出可用模型",
  "send a chat completion": "傳送聊天補全請求",
  "exfiltrate data to an outside host": "將資料外洩到外部主機",
  "read cloud-instance credentials (metadata SSRF)": "讀取雲執行個體憑證（後設資料 SSRF）",
  "clone tooling from GitHub": "從 GitHub 克隆工具",
  "reach the inference API as a stray curl, not the runtime": "繞過執行階段，直接用 curl 存取推理 API",
  "pull an npm package directly with curl": "直接使用 curl 拉取 npm 軟體包",
  "Run the live-policy cell above to draw your launchable's policy as an interactive map.": "請執行上方的即時策略單元格，將可啟動執行個體的策略繪製為互動式地圖。",
  "tips for building a RAG pipeline": "建置 RAG 工作流程的建議",
  "The Agent": "代理程式",
  "The ReAct Loop": "ReAct 迴圈",
  "Tools at Scale": "規模化工具",
  "Workflows": "工作流程",
  "The Index Agent": "索引代理程式",
  "Deep Agents": "深度代理程式",
  "Connect NemoClaw": "連線 NemoClaw",
  "Always-On": "持續執行",
  "Modern CLIs": "現代 CLI",
  "Going Further": "深入探索",
  "loop · LLM as function": "迴圈 · 將 LLM 作為函式",
  "tools · finish_reason": "工具 · finish_reason",
  "JSON · MCP · routing": "JSON · MCP · 路由",
  "router · planner · ReWOO": "路由 · planner · ReWOO",
  "embed · retrieve · bundle": "嵌入 · 檢索 · 打包",
  "planner · sub-agents · VFS": "planner · 子代理程式 · VFS",
  "launchable · first call": "可啟動 · 首次呼叫",
  "file-as-context · paste URL": "檔案即上下文 · 貼上 URL",
  "sandbox · policy · CI gate": "沙盒 · 策略 · CI 門控",
  "Section": "章節",
  "Section 1": "第 1 章",
  "Section 2": "第 2 章",
  "Section 3": "第 3 章",
  ...
  "Remote progress is off. Nothing is sent until you enable it.": "遠端進度同步已關閉。啟用前不會傳送任何資料。",
  "Enable remote progress": "啟用遠端進度同步",
  "Disconnect this tab": "中斷此分頁的連線",
  "Record selections of approved NVIDIA resources": "記錄對已核准 NVIDIA 資源的選擇",
  "Data, purpose, and retention": "資料、用途與保留期限",
  "Sent to NVIDIA DLI Activity API": "傳送至 NVIDIA DLI Activity API",
  "Purpose": "用途",
  "Service status": "服務狀態",
  "NVIDIA Privacy Policy": "NVIDIA 隱私權政策",
  "Privacy choices and requests": "隱私權選擇與申請",
  "Global Privacy Control is enabled. Referral tracking remains off.": "已啟用全球隱私控制。資源選擇記錄將維持關閉。",
  "Connecting to the Activity API.": "正在連線至 Activity API。",
  "Saved progress:": "已儲存的進度：",
  "Last confirmed progress:": "上次確認的進度：",
  "Refresh saved progress": "重新整理已儲存的進度",
  "Waiting for API confirmation.": "正在等待 API 確認。",
  "Confirmed by the Activity API.": "已由 Activity API 確認。",
  "Progress records successful course activity checkpoints.": "進度記錄課程活動中已成功完成的檢查點。",
  "The Activity API is unavailable. Local course work is unchanged.": "Activity API 目前無法使用。本機課程進度不受影響。",
  "Remote progress is available only from a validated course build.": "遠端進度同步僅適用於經過驗證的課程建置。",
  "Open this course over HTTPS to enable remote progress.": "請透過 HTTPS 開啟本課程，以啟用遠端進度同步。",
  "Remote progress is enabled.": "已啟用遠端進度同步。",
  "Remote progress is unavailable until its data policy is approved.": "資料政策核准前，遠端進度同步無法使用。",
  "Local verified progress:": "本機驗證進度：",
  "Last connection:": "最近一次連線：",
  "Remote collection is disabled while privacy, legal, and service-owner review is incomplete.": "隱私、法律及服務負責人審查完成前，遠端資料收集將維持關閉。",
  "Service retention:": "服務端保留期限：",
  "Service-specific retention is not yet confirmed. Remote collection remains disabled.": "服務端保留期限尚未確認。遠端資料收集將維持關閉。",
  "Service controller:": "服務資料控管者：",
  "The service controller is not yet confirmed. Remote collection remains disabled.": "服務資料控管者尚未確認。遠端資料收集將維持關閉。",
  "Service legal basis:": "服務處理資料的法律依據：",
  "The service legal basis is not yet confirmed. Remote collection remains disabled.": "服務處理資料的法律依據尚未確認。遠端資料收集將維持關閉。",
  "Service sale or sharing disposition:": "服務關於出售或分享資料的說明：",
  "The service sale or sharing disposition is not yet confirmed. Remote collection remains disabled.": "服務關於出售或分享資料的說明尚未確認。遠端資料收集將維持關閉。",
  "Published service target:": "已發布的服務目標：",
  "No course-level availability or response-time target is published. Live status is an observation, not an SLA.": "課程尚未發布可用性或回應時間目標。目前狀態只是觀測結果，不構成 SLA。",
  "No connection has been measured in this tab.": "此分頁尚未測量任何連線。",
  "The course does not send API keys, prompts, model responses, terminal output, or workspace files to the Activity API.": "本課程不會向 Activity API 傳送 API 金鑰、提示詞、模型回覆、終端機輸出或工作區檔案。",
  "course artifact identifier, version, and digest": "課程建置的識別碼、版本與摘要",
  "opaque activity session identifier and token": "不透明的活動工作階段識別碼與權杖",
  "verified course progress and completion time": "經驗證的課程進度與完成時間",
  "approved NVIDIA resource identifier and destination when referral tracking is enabled": "啟用資源選擇記錄時，已核准 NVIDIA 資源的識別碼與目的地",
  "ordinary HTTPS request metadata available to the service operator": "服務營運方可見的一般 HTTPS 請求中繼資料",
  "save verified course progress and completion": "儲存經驗證的課程進度與完成狀態",
  "measure selections of approved NVIDIA resources when referral tracking is enabled": "啟用資源選擇記錄時，統計對已核准 NVIDIA 資源的選擇",
  "The session identifier and token remain in sessionStorage until the tab closes or the learner disconnects remote progress.": "工作階段識別碼與權杖會保留在 sessionStorage 中，直到分頁關閉或學習者中斷遠端進度同步。",
  "Remote progress is off. Open Activity in the toolbar to enable it.": "遠端進度同步已關閉。請在頂端工具列中開啟「學習記錄」以啟用同步。",
  "Course completed": "課程已完成",
  "Course completed. You can return to the course home or continue exploring the resources above.": "課程已完成。您可以返回課程首頁，或繼續瀏覽上方資源。",
  "All verified checkpoints are complete. Finish the course when you are ready.": "所有驗證檢查點均已完成。準備好後即可完成課程。",
  "Verified progress:": "驗證進度：",
  "Complete the remaining hands-on checkpoints before finishing.": "完成其餘實作檢查點後再結束課程。",
  "Course progress is temporarily unavailable. Reload this page to try again.": "課程進度暫時無法使用。請重新載入此頁面後再試一次。",
  "Recording course completion.": "正在記錄課程完成狀態。",
  "Completion was not recorded. Check your connection and try again.": "未能記錄課程完成狀態。請檢查連線後再試一次。",
  "Not available in this language; opens in English.": "此語言版本尚未提供；將開啟英文頁面。",
  "course home": "課程首頁",
  "click to see all sections": "點選檢視所有章節",
  "start": "開始",
  "end": "結束",
  ...
  "Model": "模型",
  "Pages": "頁面",
  "none pinned = auto-select": "未固定 = 自動選擇",
  "🧠 memory: on": "🧠 記憶：開啟",
  "🧠 memory: off": "🧠 記憶：關閉",
  "↺ New chat": "↺ 新建對話",
  "Ask a question…": "請輸入問題…",
  "Send": "傳送",
  "⏹ Stop": "⏹ 停止",
  "▶ Run": "▶ 執行",
  "▶ Run all": "▶ 全部執行",
  "Reset when you click <strong>▶ Run all</strong>.": "點選 <strong>▶ 全部執行</strong> 時重置。",
  "Use <code>log.clear()</code>, then clear the panel.": "使用 <code>log.clear()</code>，然後清除面板。",
  "⏳ Running…": "⏳ 正在執行…",
  "↺ Reset": "↺ 重置",
  "↺ Reset code": "↺ 重置程式碼",
  "Ready": "就緒",
  ...
  "Stopping…": "正在停止…",
  "+ branch": "+ 分支",
  "Connect your launchable on Module 3a first (its URL and token), then your agent is reachable here.": "請先在模組 3a 中連線可啟動執行個體（其 URL 和 token），然後即可從此處存取代理程式。",
  "Connected to your agent over the gateway. Ask anything, type /help, click a prompt, or press Tab to autocomplete.": "已透過閘道器連線到代理程式。可以提出任何問題、輸入 /help、點選提示詞，或按 Tab 鍵自動補全。",
  "Use /commands for the live gateway list. /clear empties this screen; /new and /branch manage independent agent sessions. Text without a slash is sent to the active agent session.": "使用 /commands 檢視閘道器的即時命令列表。/clear 會清空此螢幕；/new 和 /branch 用於管理相互獨立的代理程式會話。不帶斜槓的文字將傳送到當前代理程式會話。",
  "No commands reported by the gateway.": "閘道器未報告任何命令。",
  "setting up this session (the first reply takes a moment)…": "正在設定此會話（首次回覆需要一些時間）…",
  "empty until you Run": "在您執行前為空",
  "reset. empty until you Run": "已重置。在您執行前為空",
  "javascript · editable · re-run": "javascript · 可編輯 · 可重新執行",
  "JSON · editable": "JSON · 可編輯",
  "click to collapse": "點選摺疊",
  "click to expand": "點選展開",
  "in scope inside every node:": "每個節點內的作用域均包含：",
  "click a row to inspect & edit its source": "點選行可檢查並編輯其原始碼",
  "in scope for this cell. Click a row to read its source": "位於此單元格的作用域內。點選行可檢視其原始碼",
  "✓ API key available in this tab": "✓ 此標籤頁中可使用 API key",
  "Chat route:": "聊天路由：",
  "Embedding route:": "嵌入路由：",
  "Chat API base URL": "聊天 API 基礎 URL",
  "Chat model ID": "聊天模型 ID",
  "Chat API bearer key (NVIDIA keys start with": "聊天 API bearer 金鑰（NVIDIA 金鑰以以下內容開頭",
  "Embedding route (persistent and independent)": "嵌入路由（持久且獨立）",
  "Embedding exercises keep this route when the chat route changes.": "聊天路由發生變化時，嵌入練習仍使用此路由。",
  "Embedding API base URL": "嵌入 API 基礎 URL",
  "Embedding model ID": "嵌入模型 ID",
  "Embedding API bearer key": "嵌入 API bearer 金鑰",
  "Base URL": "基礎 URL",
  "Bearer token": "Bearer token",
  "Access provider": "存取提供商",
  "Access session": "存取會話",
  "Enter the launchable URL and its browser access session. The course discovers everything else.": "輸入可啟動執行個體的 URL 及其瀏覽器存取會話。本課程會自動發現其他所有資訊。",
  "Enter Base URL and Access session. Provider, relay route, and gateway token are discovered automatically.": "輸入 Base URL 和 Access session。系統會自動發現提供商、中繼路由和閘道器 token。",
  "Show session": "顯示會話",
  "Show or hide access session": "顯示或隱藏存取會話",
  "Hide session": "隱藏會話",
  "Test connection": "測試連線",
  "Test again": "再次測試",
  "Waiting to test.": "等待測試。",
  "Agent metadata": "代理程式後設資料",
  "Gateway WebSocket": "閘道器 WebSocket",
  "Terminal WebSocket": "終端機 WebSocket",
  "Health": "健康狀態",
  "Pending": "待處理",
  "Testing": "正在測試",
  "Passed": "已透過",
  "Failed": "失敗",
  "Redacted request and response": "已隱去敏感資訊的請求和回應",
  "Provider and transport are discovered from the Base URL.": "系統會根據基礎 URL 自動發現提供商和傳輸方式。",
  "Paste the launchable browser session when this page is hosted separately": "當此頁面單獨託管時，請貼上可啟動執行個體的瀏覽器會話",
  "Detected automatically from Base URL:": "根據基礎 URL 自動檢測：",
  "Access session:": "存取會話：",
  "Sensitive values stay in this tab.": "敏感值僅保留在此標籤頁中。",
  "Paste _pomerium when this page is hosted separately": "當此頁面單獨託管時，請貼上 _pomerium",
  "Paste CF_Authorization when this page is hosted separately": "當此頁面單獨託管時，請貼上 CF_Authorization",
  "Checking this browser for a signed-in launchable session.": "正在檢查此瀏覽器中是否存在已登入的可啟動執行個體會話。",
  "Signed-in browser session detected.": "檢測到已登入的瀏覽器會話。",
  "Query": "查詢",
  "What": "內容",
  "Why": "原因",
  "Credential": "憑證",
  "Failure": "失敗",
  "Testing required routes in order.": "正在按順序測試必需路由。",
  "Enter the NemoClaw launchable Base URL.": "請輸入 NemoClaw 可啟動執行個體的基礎 URL。",
  "Connection ready. Metadata, gateway, terminal, and health checks passed.": "連線已就緒。後設資料、閘道器、終端機和健康檢查均已透過。",
  "Connection failed. Open the failed check for its redacted request and response.": "連線失敗。請開啟失敗的檢查，檢視其中已隱藏敏感資訊的請求和回應。",
  "Gateway recovery": "閘道器恢復",
  "Retry Cloudflare WebSockets through the hosted relay": "透過託管中繼重試 Cloudflare WebSockets",
  "Use only when a direct Cloudflare gateway or terminal socket fails.": "僅當 Cloudflare 閘道器或終端機套接字的直接連線失敗時使用。",
  "The recovery relay applies only to Cloudflare Access launchables.": "恢復中繼僅適用於 Cloudflare Access 可啟動執行個體。",
  "Use the NemoClaw App URL: https://nemoclaw-<id>.brevlab.com or https://nemoclaw-<id>.apps.run.brev.nvidia.com": "使用 NemoClaw 應用 URL：https://nemoclaw-<id>.brevlab.com 或 https://nemoclaw-<id>.apps.run.brev.nvidia.com",
  "Access provider must be Automatic, Cloudflare Access, or Pomerium": "存取提供方必須為“自動”、Cloudflare Access 或 Pomerium",
  "Selected access provider does not match the launchable URL": "所選存取提供方與可啟動執行個體 URL 不匹配",
  "OpenClaw relay URL cannot include credentials, query parameters, or a fragment": "OpenClaw 中繼 URL 不能包含憑證、查詢引數或片段",
  "Automatic from URL": "根據 URL 自動選擇",
  "Cloudflare Access": "Cloudflare Access",
  "Pomerium": "Pomerium",
  "Hosted relay": "託管中繼",
  "Relay URL": "中繼 URL",
  "Use for cross-origin Cloudflare connections": "用於跨源 Cloudflare 連線",
  "saved separately": "單獨儲存",
  "Model endpoint:": "模型 API 入口：",
  "Model API base URL": "模型 API 基礎 URL",
  "Custom endpoint uses direct browser requests": "自訂 API 入口使用瀏覽器直接請求",
  "Use the NVIDIA DLI browser relay": "使用 NVIDIA DLI 瀏覽器中繼",
  "Change": "更改",
  "API bearer key (NVIDIA keys start with": "API bearer 金鑰（NVIDIA 金鑰以此開頭：",
  "Save & verify": "儲存並驗證",
  "No key yet?": "還沒有金鑰？",
  "Sign up at build.nvidia.com →": "前往 build.nvidia.com 註冊 →",
  "Key should start with nvapi-": "金鑰應以 nvapi- 開頭",
  "Enter the key for this endpoint": "請輸入此 API 入口的金鑰",
  "Verifying?": "正在驗證？",
  "Discovering models and verifying…": "正在發現模型並驗證…",
  "✓ Connected.": "✓ 已連線。",
  "Model API base URL must use HTTPS": "模型 API 基礎 URL 必須使用 HTTPS",
  "Model API base URL cannot include credentials, query parameters, or a fragment": "模型 API 基礎 URL 不能包含憑證、查詢引數或片段",
  "Model ID must be one non-empty value without spaces": "模型 ID 必須是一個不含空格的非空值",
  "localhost points to this browser, not a remote host. Enter the HTTPS model API base URL ending in /v1": "localhost 指向此瀏覽器，而非遠端主機。請輸入以 /v1 結尾的 HTTPS 模型 API 基礎 URL",
  "A Brev Jupyter /lab URL is not a model API. Enter the HTTPS model API base URL ending in /v1": "Brev Jupyter /lab URL 不是模型 API。請輸入以 /v1 結尾的 HTTPS 模型 API 基礎 URL",
  "Model discovery did not return JSON. Confirm this endpoint serves the OpenAI-compatible /models route, then try again": "模型發現未傳回 JSON。請確認此 API 入口提供與 OpenAI 相容的 /models 路由，然後重試",
  "then open API Keys and generate one. This tab reuses the keys across lessons and discards them when it closes.": "然後開啟 API 金鑰頁面並生成一個金鑰。此標籤頁會在各課時之間複用這些金鑰，並在關閉時將其丟棄。",
...
const TW_PREFIXES = new Map(Object.entries({
  "Prerequisite: ": "前提條件：",
  "running ": "正在執行 ",
  "commands.list failed: ": "commands.list 失敗：",
  "branches: ": "分支：",
  "Branch '": "分支 '",
  "context ": "上下文 ", "done in ": "完成，用時 ", "── call ": "── 呼叫 ",
  "✗ stopped at ": "✗ 已停止於 ", "🧠 reasoning · ~": "🧠 推理 · ~",
  "✓ Connected. Model replied: ": "✓ 已連線。模型回覆：",
  "Connection failed: ": "連線失敗：",
  "Model ID is not served by this endpoint. Choose one of: ": "此 API 入口不提供模型 ID。請選擇以下模型之一：",
  "Embedding model ID is not served by this endpoint. Choose one of: ": "此 API 入口不提供嵌入模型 ID。請選擇以下模型之一：",
  "A NemoClaw launchable is not a model API. Connect it in Module 3a and keep this route on a model endpoint such as ": "NemoClaw 可啟動執行個體不是模型 API。請在模組 3a 中連線該執行個體，並將此路由保留為模型 API 入口，例如 ",
  "model discovery failed: ": "模型發現失敗：",
  "embedding model discovery failed: ": "嵌入模型發現失敗："
}));

const TW_ATTRS = new Map(Object.entries({
  "Ask a question…": "請輸入問題…",
  "Course progression; current step highlighted.": "課程進度；當前步驟已突出顯示。",
  "Show the whole course map": "顯示完整課程地圖",
  "Choose language": "選擇語言",
  "Run every node in order": "按順序執行所有節點",
  "Run this cell": "執行此單元格",
  "Restore every node's code to its original": "將所有節點的程式碼恢復為原始版本",
  "Restore this cell's original code and clear its output": "恢復此單元格的原始程式碼並清除其輸出",
  "Copy current code": "複製當前程式碼",
  "model key verified this session": "模型金鑰已在本次會話中驗證",
  "the saved nvapi key was refused (401/403). Re-enter it on Module 1a.": "已儲存的 nvapi 金鑰被拒絕（401/403）。請在模組 1a 中重新輸入。"
}));
...
const TW_HELPER_DESCRIPTIONS = new Map(Object.entries({
  ...
  instantAnswer: "當查詢中明確包含某個術語時，傳回一條 NVIDIA 術語表定義，例如 <code>retrieval-augmented generation</code> 或 <code>deep agents</code>。傳回結構與 <code>webSearch</code> 相同，但只有查詢與術語高度匹配時才傳回一張精選卡片；自由問句不會傳回結果。它是 <code>webSearch</code> 面向具體實體的精確查詢版本。",
  formatSearchResults: "將 <code>webSearch</code> 或 <code>instantAnswer</code> 的結果轉換為帶編號的文字塊，供 LLM 作為工具訊息讀取。",
  embed: "向持久化嵌入路由 <code>{cfg.url}/embeddings</code> 傳送 POST 請求。傳回向量陣列（<code>numbers[]</code>）。NVIDIA 嵌入模型要求將 <code>inputType</code> 設為 <code>\"query\"</code> 或 <code>\"passage\"</code>。",
  cosineSim: "計算兩個向量的餘弦相似度。越接近 1，匹配度越高。這是標準的檢索基本操作。",
  fetchRetry: "與 <code>helpers.fetch</code> 類似，並可接受一個有界的可選第三引數，例如 <code>{ retries: 2, timeoutMs: 120000 }</code>。遇到 HTTP 429 時會遵循 <code>Retry-After</code>，其他情況下則報告最終的網路或 HTTP 結果。",
  delay: "等待指定時間，同時允許學習者停止正在執行的單元格。CanvasFlow 和 RunCell 會自動將此輔助函式連線到停止按鈕；只有等待過程屬於其他生命週期時，才需要傳入另一個 <code>AbortSignal</code>。",
  ...
  estimateTokens: "<code>helpers.estimateTokens(textOrMessages)</code> 粗略估算字串或 <code>{content}</code> 訊息陣列中的 token 數量，約按每 4 個字元一個 token 計算。它適合執行前檢查；權威計數以模型傳回的 <code>usage_metadata</code> 為準。",
  browserChatFetch: "傳回一個會移除 OpenAI SDK <code>x-stainless-*</code> 標頭的 <code>fetch</code>。NVIDIA 模型路由還會收到 <code>X-BILLING-INVOKE-ORIGIN</code> 追蹤標記；自訂路由會包含相應的瀏覽器會話憑證。在瀏覽器中構造 <code>ChatOpenAI</code> 時，將它傳給 <code>configuration.fetch</code>。",
  diagramSVG: "以 SVG 字串形式傳回使用課程主題的節點/邊圖，也就是 <code>helpers.viz.diagram</code> 的字串版本，互動頁面可透過 <code>view.html(...)</code> 呈現。<code>spec</code> 結構相同：<code>{title?, nodes:[{id, label, kind, x, y, lines?}], edges:[{from, to, label?}]}</code>；<code>kind &isin; env|agent|tool|data|model|neutral</code>。",
  ganttBarsSVG: "以 SVG 字串形式傳回甘特式併發圖，也就是 <code>helpers.viz.ganttBars</code> 的字串版本，可由互動頁面透過 <code>view.html(...)</code> 呈現。<code>workers</code> 是 <code>{label, dt}</code> 陣列，時間單位為秒；圖表會將各工作執行緒的條形及序列耗時之和與實際 <code>wallSeconds</code> 進行比較。",
  mountFigures: "將 <code>rootSel</code> 下的每個 <code>[data-svg-src]</code> 佔位符替換為從相應路徑獲取的 SVG；預設範圍是整個文件。SVG 會以內聯方式注入，使 <code>var(--gfx-*)</code> 主題生效，並支援單擊或按 Enter 開啟適應螢幕的燈箱。頁面載入時會自動掛載。",
  mountChatUI: "在 <code>el</code> 中呈現可即時觀察的聊天介面，包括控制元件、流式對話記錄和輸入框。<code>opts</code> 包含 <code>{ modules:[{id,title}], models:[{id,label}], intro, greeting, showGreetingWithHistory, memory, respond(text, ctx), onReset() }</code>。恢復歷史輪次後仍需顯示當前上下文提示時，請設定 <code>showGreetingWithHistory:true</code>。設定 <code>memory:true</code> 後，元件會保留對話、顯示預設開啟的記憶開關，並透過 <code>ctx.history</code> 提供先前輪次；關閉記憶時該陣列為空，因此同一個 respond 會表現為無狀態函式。編輯按鈕會將對話記錄回退到相應輪次。<code>respond</code> 透過 <code>ctx.view</code> 流式輸出：<code>view.token(t)</code> 顯示以 Markdown 呈現的回答，<code>view.reasoning(t)</code> 顯示可摺疊的思考過程，<code>view.tool(label, detail)</code> 顯示可展開的工具標籤，<code>view.usage({input, output})</code> 顯示本輪 token 和累計上下文，另有 <code>view.html(h)</code> 與 <code>view.error(msg)</code>。<code>ctx</code> 包含 <code>{ module, modules, model, thread, turn, history, memory }</code>；<code>modules</code> 是固定的頁面 ID 陣列，為空時自動選擇。傳回 <code>{ thread, reset(), ctx }</code>。",
  mountAgentChat: "基於 LangChain <code>createReactAgent</code> 的即時聊天介面。<code>opts</code> 包含 <code>{ models:[{id,label}], system, buildTools({tool,z,coursePage,coursePages,webSearch,formatSearchResults}), greeting, modules, recursionLimit, growLog, initialHistory, initialActivity, onUserMessage, onTurnSnapshot, onAssistantMessage, onHistoryChange, compactAtTokens, compactKeepMessages }</code>。恢復的歷史記錄會初始化新的 checkpoint；壓縮操作使用當前模型總結較早輪次、保留最近訊息並切換到新 thread。設定 <code>growLog:true</code> 後會移除面板內部的滾動高度限制，使長對話隨頁面展開。此函式載入課程附帶的 LangChain bundle，為每個模型建置一個代理程式，透過 MemorySaver 支援多輪對話，流式顯示 token 和工具標籤，並處理缺少金鑰的情況。它是 <code>mountChatUI</code> 的現成代理程式版本。",
  mountOpenClawCli: "掛載 OpenClaw 即時命令/聊天介面，無需將閘道器 RPC、會話標籤頁、自動補全和呈現支撐程式碼複製到學習者單元格中。",
  ...
  getModelApiBaseUrl: "傳回已儲存的模型 API 基礎 URL；沒有有效的自訂值時傳回課程預設值。",
  setModelApiBaseUrl: "驗證並儲存模型 API 基礎 URL，然後清除本標籤頁快取的模型設定。",
  isDefaultModelApiBaseUrl: "判斷 URL 是否使用課程批准的 NVIDIA 模型路由。",
  openclawLoopbackProbe: "透過 Pomerium 可啟動執行個體的終端機讀取獲准的 OpenClaw 引導端點，而不暴露瀏覽器 cookie。",
  openFigureLightbox: "在支援鍵盤操作的共享燈箱中開啟 SVG 副本。",
  wireFigureZoom: "使 SVG 可透過單擊、Enter 或空格鍵開啟共享燈箱。",
  mountConsole: "掛載帶歷史記錄、建議、補全、取消和輸出鉤子的終端機式控制檯。",
  openclawGatewayWsUrl: "為 OpenClaw 閘道器生成直連或獲准中繼的 WebSocket URL。",
  refreshOpenClawGatewayToken: "從已驗證的代理程式後設資料重新整理閘道器 token，並僅儲存在本標籤頁中。",
  runOpenClawConnectionAudit: "依次測試可啟動執行個體的後設資料、閘道器、終端機和健康路由，並傳回隱藏敏感資訊證據。",
  redactOpenClawDiagnostic: "遞迴移除 OpenClaw 診斷資料中的憑證及含憑證的 URL。",
  getOpenClawConnection: "遷移舊儲存後，傳回規範化的可啟動執行個體路由、提供商和標籤頁憑證。",
  setOpenClawConnection: "驗證並儲存可啟動執行個體路由，同時將憑證限制在本標籤頁。",
  filterOpenClawRuntimeNoise: "移除已知容器噪聲，同時保留與學習相關的 OpenClaw 輸出。",
  filterOpenClawRuntimeValue: "遞迴過濾陣列和物件內字串中的 OpenClaw 噪聲。",
  openclawMessageText: "從字串或內容塊陣列形式的閘道器訊息中提取乾淨文字。",
  openclawResultText: "從 OpenClaw 工具結果及其結構化內容塊中提取乾淨文字。",
  mountModelEndpointProbe: "掛載可啟動執行個體連線探測旁的只讀模型 API 入口檢視。",
  mountPolicyMap: "根據提供的策略掛載互動式 OpenShell 信任邊界圖。",
  "viz.diagram": "根據資料規範自動生成適配主題的節點/邊圖。<code>spec</code> 為 <code>{title?, caption?, nodes:[{id, label, kind, x, y, lines?}], edges:[{from, to, label?}]}</code>；<code>kind &isin; env|agent|tool|data|model|neutral</code>；<code>x</code> 和 <code>y</code> 表示網格列與行。",
  "viz.lineChart": "為數值序列生成靜態折線圖。<code>opts</code> 為 <code>{title?, xLabel?, yLabel?, min?, max?, width?}</code>。SVG 的無障礙標籤中包含資料點數值；學習者需要精確資料時，請另行傳回源陣列。",
  "viz.scoreBarChart": "生成 1 到 5 分的評分條形圖，併疊加閾值和平均值。<code>scored</code> 是 <code>{score, label?}</code> 陣列；<code>opts</code> 為 <code>{threshold, title, width}</code>。",
  "viz.messageList": "用顏色區分的訊息序列，其中 USER 為藍色、ASSISTANT 為綠色、TOOL 為琥珀色。直接接收 OpenAI 格式的 <code>messages</code> 陣列。",
  "viz.ganttBars": "甘特式條形圖，用於比較各工作執行緒耗時和總牆鍾時間。",
  "viz.retrievalBars": "檢索結果的水平分數條形圖，以綠色突出顯示 top-k 條目，並調暗其他條目。",
  "viz.diffTable": "生成前後對比表，包含按變化著色的差值、勾選標記、頁尾說明，以及可選的 <code>verdict({rows})</code>；該函式傳回 <code>{ok, text}</code>。<code>spec.rows</code> 條目可以是 <code>{kind:\"check\", label, left, right}</code>，也可以是 <code>{kind:\"num\", label, left, right, betterWhen:\"up\"|\"down\", fmt?}</code>。",
  "viz.chat": "以不同顏色的氣泡顯示聊天記錄。<code>turns</code> 是 <code>[role, content]</code> 對的陣列；<code>role &isin; {user, assistant|ai, system, tool}</code>。<code>opts.maxChars</code> 用於限制每輪顯示的字元數。",
  "viz.sideBySide": "並排顯示兩列文字。<code>opts</code> 為 <code>{leftTitle, rightTitle, footer}</code>。",
  state: "所有節點共享的普通物件。在一個節點中設定欄位，例如 <code>state.question = \"…\"</code>，之後的任意節點都可以讀取。點選 <strong>▶ 全部執行</strong> 時，此物件會重置。",
  fetch: "瀏覽器原生的 <code>fetch</code>，保持原樣公開，使節點可以直接呼叫任意 HTTP API 入口。引數和傳回的 <code>Response</code> 與平臺 API 完全相同。它不會重試，也不會附加金鑰：上游服務不穩排程請使用 <code>helpers.fetchRetry</code>；模型、搜尋或嵌入呼叫則優先使用上方的專用輔助函式，由它們自動新增路由和金鑰。",
  trace: "向每個 CanvasFlow 獨立的追蹤儲存中寫入一個符合 OTel 結構的 span 事件。任何實際執行工作的步驟都應記錄，而不僅限於 LLM 呼叫。後續節點可以讀取 <code>state.__trace</code>，檢視所有已寫入事件。",
  log: "向當前單元格的<em>日誌</em>區域追加內容。普通值以文字形式追加，物件則呈現為帶語法高亮的 JSON。CanvasFlow 和 RunCell 共用以下介面：<code>log(...args)</code>、<code>log.h(title)</code>、<code>log.json(label?, value)</code>、<code>log.kv(object)</code>、<code>log.details(summary, body)</code>、<code>log.html(html)</code>、<code>log.svg(svgString)</code>、<code>log.draw(W, H, body, opts)</code> 和 <code>log.clear()</code>。",
  signal: "本次執行對應的 <code>AbortSignal</code>，已連線到停止按鈕。<code>helpers.delay</code>、<code>helpers.chat</code> 和 <code>chatStream</code> 會自動使用它。將它傳給 <code>helpers.fetch</code> 或您自己的 <code>WebSocket</code> 清理邏輯，確保學習者按下停止按鈕後，長時間執行的任務能夠真正取消。"
}));
...
const LOCALE_MAPS = Object.freeze({
  ...
  "zh-tw": localeSpec(TW_TEXT, TW_ATTRS, TW_PREFIXES, "上一課：", "下一課："),
...
const DYNAMIC_TEXT = Object.freeze({
  ...
  "zh-tw": [
    [/^\+ show all (\d+) more helpers$/, m => `+ 顯示其餘 ${m[1]} 個輔助函式`],
    [/^− show only this (section|cell)'s helpers$/, m => `− 僅顯示此${m[1] === "cell" ? "單元格" : "章節"}的輔助函式`],
    [/^javascript · editable · (\d+) lines$/, m => `javascript · 可編輯 · ${m[1]} 行`],
    [/^✓ ran (\d+) nodes$/, m => `✓ 已執行 ${m[1]} 個節點`],
    [/^⏹ stopped after (\d+) of (\d+) nodes$/, m => `⏹ 執行 ${m[1]}/${m[2]} 個節點後停止`],
  ],
});
...
function normalizeZhInlineSpacing(root) {
  if (!document.documentElement.lang.toLowerCase().startsWith("zh-") || !root) return;
  const containers = [];
...
function rewriteUnavailableCourseLinks(current, fallback, manifestUrl) {
  ...
  document.querySelectorAll('a[href]').forEach(anchor => {
    ...
    const note = translatedText("Not available in this language; opens in English.");
...
export async function mountLanguageMenu() {
  ...
  button.type = "button";
  button.textContent = "🌐";
  button.setAttribute("aria-label", translatedText("Choose language"));
  ...
  languages.forEach(entry => {
    ...
    if (!hasPage(entry, file)) {
      ...
      small.textContent = translatedText("course home");
