...
export function artifactCodeIssue(artifact) {
  ...
  if (/(?:\bfetch\s*\(|\bXMLHttpRequest\b|\bWebSocket\s*\(|\blocalStorage\b|\bsessionStorage\b|\bindexedDB\b)/.test(javascript)) {
