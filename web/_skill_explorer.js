...
(function () {
  ...
  function injectChrome(loadSourceHighlighter) {
    ...
    s.textContent = [
      ...
      ".rp-wrap{display:grid;grid-template-columns:minmax(0,264px) minmax(0,1fr);min-width:0;min-height:60vh}@media(max-width:760px){.rp-wrap{grid-template-columns:minmax(0,1fr)}}",
      ".rp-rail{border-right:1px solid var(--e3);padding:1rem .6rem 5rem;min-width:0;max-width:100%}",
      ".rp-rail button{display:flex;width:100%;min-width:0;max-width:100%;align-items:center;gap:8px;background:none;border:0;color:var(--td);text-align:left;padding:8px 10px;border-radius:7px;cursor:pointer;font:inherit;font-size:.9rem}",
